...
past_score = st.number_input("Past Exam Score",min_value=0.0,max_value=100.0,value=70.0,step=1.0)
family_support = st.number_input("Family Support (1 = Yes, 0 = No)",min_value=0,max_value=1,value=1,step=1)
extra_classes = st.number_input("Extra Classes per Week",min_value=0,max_value=10,value=2,step=1)
